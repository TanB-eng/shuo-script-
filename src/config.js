...
const DEFAULTS = {
  ...
  // 实测(2026-08-09)：3000 时每 6~8 秒就"5s体力不足停火"，攻速被掐得极低、站桩挨打。
  // 降到 2000 仍频繁停火；再降到 1500(1.5点)：5s 窗回复 2 点/秒，剩 1.5 点仍可支撑
  // 持续射击直到下一次自然补充，DPS 明显提升；同时保命底线仍在(1.5点=可移动1.5秒)。
  fireStaminaFloorMilli: 1500,
